...
namespace VER.Crypto.JavaScience
{
    public class opensslkey
    {
        ...
        public static void DecodePEMKey(String pemstr)
        {
            ...
            else if (pemstr.StartsWith(pemp8encheader) && pemstr.EndsWith(pemp8encfooter))
            {
                ...
                if (pkcs8encprivatekey != null)
                {
                    ...
                    RSACryptoServiceProvider rsa = DecodeEncryptedPrivateKeyInfo(pkcs8encprivatekey, new SecureString());
                    if (rsa != null)
                    {
                        Console.WriteLine("\nCreated an RSACryptoServiceProvider instance\n");
                        String xmlprivatekey = rsa.ToXmlString(true);
        ...
        public static void DecodeDERKey(String filename)
        {
            ...
            rsa = DecodeEncryptedPrivateKeyInfo(keyblob, new SecureString());	//PKCS #8 encrypted
            if (rsa != null)
            {
        ...
        public static RSACryptoServiceProvider DecodeEncryptedPrivateKeyInfo(byte[] encpkcs8, SecureString IString)
        {
            // encoded OID sequence for  PKCS #1 rsaEncryption szOID_RSA_RSA = "1.2.840.113549.1.1.1"
            // this byte[] includes the sequence byte and terminal encoded null 
            ...
            try
            {
                ...
                pkcs8 = DecryptPBDK2(encryptedpkcs8, salt, IV, IString, iterations);
        ...
        //------- Parses binary ans.1 RSA private key; returns RSACryptoServiceProvider  ---SIP
        ...
        private static byte[] GetPkcs12(RSA rsa, String keycontainer, String cspprovider, uint KEYSPEC, uint cspflags)
        {
            ...
            try
            {
                ...
                SecureString pswd = GetSecPswd("Set PFX U_Password ==>");
